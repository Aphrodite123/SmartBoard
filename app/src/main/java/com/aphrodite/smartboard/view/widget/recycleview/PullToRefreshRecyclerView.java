package com.aphrodite.smartboard.view.widget.recycleview;
...
import com.aphrodite.smartboard.view.widget.recycleview.adapter.WrapperAdapter;
import com.aphrodite.smartboard.view.widget.recycleview.inter.OnLoadMoreListener;
import com.aphrodite.smartboard.view.widget.recycleview.inter.OnLoadMoreScrollListener;
import com.aphrodite.smartboard.view.widget.recycleview.inter.OnRefreshListener;
import com.aphrodite.smartboard.view.widget.recycleview.inter.RefreshTrigger;
import com.aphrodite.smartboard.view.widget.recycleview.inter.SimpleAnimatorListener;
import com.aphrodite.smartboard.view.widget.recycleview.view.RefreshHeaderLayout;
...
public class PullToRefreshRecyclerView extends RecyclerView {
    ...
    public PullToRefreshRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PullToRefreshRecyclerView, defStyle, 0);
        ...
        try {
            refreshEnabled = a.getBoolean(R.styleable.PullToRefreshRecyclerView_refreshEnabled, false);
            loadMoreEnabled = a.getBoolean(R.styleable.PullToRefreshRecyclerView_loadMoreEnabled, false);
            refreshHeaderLayoutRes = a.getResourceId(R.styleable.PullToRefreshRecyclerView_refreshHeaderLayout, -1);
            loadMoreFooterLayoutRes = a.getResourceId(R.styleable.PullToRefreshRecyclerView_loadMoreFooterLayout, -1);
            refreshFinalMoveOffset = a.getDimensionPixelOffset(R.styleable.PullToRefreshRecyclerView_refreshFinalMoveOffset, -1);
        } finally {
            a.recycle();
        }
    ...
    public void setContainerAdapter(Adapter adapter) {
        ensureRefreshHeaderContainer();
        ensureHeaderViewContainer();

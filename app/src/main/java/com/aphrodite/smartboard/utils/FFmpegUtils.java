...
//        String transformVideoCmd = "ffmpeg -i %s -vcodec libx264 -acodec copy %s";
    ...
    public static String[] generateGif(String srcFile, int startTime, int duration,
        ...
        String toGif = "ffmpeg -i %s %s";
        generateGifCmd = String.format(generateGifCmd, srcFile, startTime, duration, resolution, frameRate, targetFile);
        toGif = String.format(toGif, srcFile, targetFile);
        return toGif.split(" ");
    }
